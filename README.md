...
### ▶︎ [Open the site](https://ethanpullan.github.io/PublicTeachingTools/)

<https://ethanpullan.github.io/PublicTeachingTools/>
...
- **Design system.** Shared tokens and components live in the
  [Teaching Tools style guide](https://github.com/EthanPullan/TeachingTools/blob/main/STYLE_GUIDE.md),
  referenced rather than copied — see [`STYLE_GUIDE.md`](STYLE_GUIDE.md).
- **Upstream.** This is the public subset of
  [`EthanPullan/TeachingTools`](https://github.com/EthanPullan/TeachingTools),
  which carries the full set of tools.
